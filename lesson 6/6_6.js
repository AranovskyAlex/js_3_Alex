...
setTimeout (() => car.speedTest(), 1000);

let securedDriveInfo = () => car.driveInfo(); 
setTimeout(securedDriveInfo, 2000);
let securedImprove = car.improve.bind(car);
setTimeout(securedImprove, 3000);
